(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! D:\Labs\NetCore\PS_ASPNETCoreAngular\DutchTreat\DutchTreat\ClientApp\main.ts */
      "QqbR");
      /***/
    },
    ...
    function BNF(module, __webpack_exports__, __webpack_require__) {
      ...
      function ProductList_div_1_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProductList_div_1_Template_button_click_22_listener() {
            ...
            return ctx_r2.addProduct(product_r1);
          });
      ...
      ProductList.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 2,
        vars: 1,
        consts: [[1, "row"], ["class", "productInfo col-md-4 well well-sm", 4, "ngFor", "ngForOf"], [1, "productInfo", "col-md-4", "well", "well-sm"], [1, "card", "bg-light", "p-1", "m-1"], [1, "img-responsive", 3, "src", "alt"], [1, "productName"], ["id", "buyButton", 1, "btn", "btn-success", "btn-sm", "pull-right", 3, "click"]],
    ...
    function J4hL(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_dataService__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./shared/dataService */
      "g4ZZ");
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(routes, {
          useHash: true,
          enableTracing: false
        })]]
      });
    ...
    function JqFU(module, __webpack_exports__, __webpack_require__) {
      ...
      var Order = /*#__PURE__*/function () {
        ...
        _createClass(Order, [{
          key: "subtotal",
          get: function get() {
            return lodash_es__WEBPACK_IMPORTED_MODULE_0__["sum"](lodash_es__WEBPACK_IMPORTED_MODULE_0__["map"](this.items, function (item) {
      ...
      var Login = /*#__PURE__*/function () {
        ...
        _createClass(Login, [{
          ...
          value: function onLogin() {
            ...
            this.data.login(this.credentials).subscribe(function (success) {
              if (success) {
      ...
      var DataService = /*#__PURE__*/function () {
        ...
        _createClass(DataService, [{
          ...
          value: function login(credentials) {
            ...
            return this.http.post("/account/createtoken", credentials).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
              _this5.token = data.token;
              _this5.tokenExpiration = data.tokenExpiration;
              return true;
            }));
          }
        }, {
          ...
          value: function AddToOrder(product) {
            var item = this.order.items.find(function (item) {
